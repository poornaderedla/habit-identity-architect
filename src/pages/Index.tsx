...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-white to-blue-50 flex w-full">
      <div className="flex flex-col w-full md:w-[55%] lg:w-[58%] xl:w-3/5 2xl:w-1/2 py-10 px-2 md:px-10 mx-auto">
        {/* PAGE HEADER */}
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-blue-600 via-fuchsia-500 to-emerald-400 bg-clip-text text-transparent tracking-tight">
            Atomic Habits
          </h1>
          <p className="mt-2 text-xl text-muted-foreground">
            Build better habits by design.<br className="hidden md:block"/> Craft your "atomic habit blueprint" in small steps—powered by your identity.
          </p>
        </div>
        ...
        <CardSection
          step={1}
          title={
            <span>Identity Alignment <span className="ml-1 text-base text-emerald-600">🧠</span></span>
          }
          open={openStep === 0}
        ...
        >
          ...
          <button
            className={
              "mt-3 w-full rounded-lg px-4 py-2 font-semibold text-white transition-colors " +
              (lawCompletion[0]
        ...
        <CardSection
          step={2}
          title={<span>Law 1: Make It Obvious <span className="ml-1 text-base">👁</span></span>}
          open={openStep === 1}
        ...
        >
          <p className="mb-2 text-sm text-muted-foreground">Design your cue: Where and when does the new habit take place?</p>
          <div className="mb-2">
          ...
          <button
            className={
              "mt-4 w-full rounded-lg px-4 py-2 font-semibold text-white transition-colors " +
              (lawCompletion[1]
                ? "bg-primary/90 hover:bg-primary"
                : "bg-muted text-muted-foreground cursor-not-allowed")
            }
        ...
        <CardSection
          step={3}
          title={
            <span>Law 2: Make It Attractive <span className="ml-1 text-base text-pink-500">❤️</span></span>
          }
          open={openStep === 2}
        ...
        <CardSection
          step={4}
          title={<span>Law 3: Make It Easy <span className="ml-1 text-base text-yellow-400">⚡</span></span>}
          open={openStep === 3}
        ...
        >
          <p className="mb-2 text-sm text-muted-foreground">Break it down: What’s the smallest step you can take? Can you make starting take 2 minutes or less?</p>
          <div className="mb-2">
        ...
        <CardSection
          step={5}
          title={<span>Law 4: Make It Satisfying <span className="ml-1 text-base text-blue-500">✅</span></span>}
          open={openStep === 4}
        ...
        >
          <p className="mb-2 text-sm text-muted-foreground">Seal the habit loop with visible progress and a positive reward.</p>
          <div className="mb-2">
        ...
        {/* ------------------------------------------------------------ */}
        <div className="text-[13px] text-muted-foreground text-center mt-10 mb-2">
